          ...
          {step === 4 && (
            <div className="text-center space-y-6">
              ...
              <select
                ...
                className="w-full p-4 text-lg border-2 border-[red] border- rounded-lg focus:outline-none"
              >
          ...
          {step === 6 && (
            <div className="text-center space-y-6">
              ...
              <input
                ...
                maxLength={14}
                className={`w-full p-4 text-lg border-2 border-[red] border- rounded-lg focus:outline-none transition duration-300  ${
                  isError
                    ? "border-red-500"
